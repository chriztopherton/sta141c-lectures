...
Suppose the current estimate of the minimizer is 0.5, a gradient descent algorithm asserts that the minimum is in the opposite direction of the slope. Our next estimate would be 
$$
...
| Image data  | 4D tensors of shape (samples, height, width, channels) |
